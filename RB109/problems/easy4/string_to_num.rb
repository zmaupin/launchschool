...
# Write a method that takes a String of digits, and returns the appropriate number as an numeger. You may not use any of the methods mentioned above.
...
p string_to_numeger('4321') == 4321
p string_to_numeger('570') == 570
